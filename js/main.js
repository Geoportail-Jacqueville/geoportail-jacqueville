  ...
  <div class="footer-container">
    <div class="footer-grid">
      ...
      <div class="footer-col">
        ...
        <ul>
          <li><a href="https://geoportail-jacqueville-ird.opendata.arcgis.com/apps/439f736688bb4e8caaf5240fa48b736c/explore">Visualisation croisée</a></li>
          <li><a href="https://www.arcgis.com/apps/dashboards/a310e03a6ae74279bbf89ea7332e7f6e">Tableau de bord</a></li>
          <li><a href="https://geoportail-jacqueville-ird.opendata.arcgis.com/pages/alerte-risques">Alerte & risques</a></li>
          <li><a href="https://geoportail-jacqueville-ird.opendata.arcgis.com/pages/donnees-et-telechargement">Données territoriales</a></li>
        </ul>
      </div>
      <div class="footer-col">
        <h5>Projet & ressources</h5>
        <ul>
          <li><a href="https://geoportail-jacqueville-ird.opendata.arcgis.com/pages/observatoire">Observatoire</a></li>
